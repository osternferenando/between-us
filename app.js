...
import {
  getDatabase, ref, onValue, onDisconnect, set as rtdbSet, serverTimestamp as rtdbServerTimestamp,
...
if (!CONFIG_MISSING) {
  ...
  // Presence is optional: if firebase-config.js has no databaseURL, we just
  // fall back to always showing players as "online" (the old behavior).
